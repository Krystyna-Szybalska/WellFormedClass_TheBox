...
using WellFormedClass_TheBox;

namespace ThBoxUnitTests
{
    [TestClass]
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        public void Constructor_3params_InMilimeters(double a, double b, double c,
            double expectedA, double expectedB, double expectedC)
        {
            Pudelko p = new Pudelko(unit: UnitOfMeasure.Millimeter, a: a, b: b, c: c);
        ...
        {
            Pudelko p = new Pudelko(unit: UnitOfMeasure.Millimeter, a: a, b: b);
        ...
        {
            Pudelko p = new Pudelko(unit: UnitOfMeasure.Millimeter, a: a);
        ...
        {
            Pudelko p = new Pudelko(a, b, c, unit: UnitOfMeasure.Millimeter);
        }
        ...
        {
            Pudelko p = new Pudelko(a, b, unit: UnitOfMeasure.Millimeter);
        }
        ...
        {
            Pudelko p = new Pudelko(a, unit: UnitOfMeasure.Millimeter);
        }
